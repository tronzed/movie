        ...
        <>            
           ...
           {console.log(movieData?.results[1].backdrop_path)} 
            ...
            <section style={{backgroundImage:`url(https://image.tmdb.org/t/p/w1920/${movieData?.results[random()].backdrop_path})`}} className={`text-gray-600 body-font bg-red-50 bg-center relative after:absolute after:block after:content-['*'] after:w-full after:bg-gray-950 after:opacity-50 after:top-0 after:left-0 after:h-full`}>
                <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center z-10 relative">
                    <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">Welcome</h1>
                        <p className="mb-8 leading-relaxed  text-zinc-300">Millions of movies, TV shows and people to discover. Explore now.</p>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="flex flex-col text-center w-full mb-5">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Trending</h1>
                    </div>
